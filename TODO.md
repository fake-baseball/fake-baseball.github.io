# BFBL Website — TODO / Brainstorm

- [ ] Write down TODOs and manage this list properly

## Home Page
- [ ] Latest news / recent activity
...
## Awards
- [ ] Awards page
  - [ ] List of award types (MVP, Cy Young, Rookie of the Year, Gold Glove, etc.)
  - [ ] Winner per season for each award
  - [ ] All-time winners list per award
  - [ ] Player page links

## Hall of Fame
- [ ] Hall of Fame page
  - [ ] Inductee list with year inducted
...
## Glossary
- [ ] Glossary page
  - [ ] All stats from the registry with name and description
  - [ ] Grouped by category (batting, pitching, baserunning, fielding, value)
  - [ ] Formula or plain-language explanation for each
