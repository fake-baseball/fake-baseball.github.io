...
REGISTRY = {
    ...
    'PP':       {'name': 'PP',       'type': 'text',    'align': 'left',  'context': 'meta'},
    'pos2':     {'name': '2P',       'type': 'text',    'align': 'left',  'context': 'meta'},
    'Role':     {'name': 'Role',     'type': 'text',    'align': 'left',  'context': 'meta'},
    'Throws':   {'name': 'T',        'type': 'text',    'align': 'left',  'context': 'meta'},
    'Bats':     {'name': 'B',        'type': 'text',    'align': 'left',  'context': 'meta'},
    'power':    {'name': 'POW',      'type': 'integer', 'align': 'right', 'context': 'meta'},
    'contact':  {'name': 'CON',      'type': 'integer', 'align': 'right', 'context': 'meta'},
    'speed':    {'name': 'SPD',      'type': 'integer', 'align': 'right', 'context': 'meta'},
    'fielding': {'name': 'FLD',      'type': 'integer', 'align': 'right', 'context': 'meta'},
    'arm':      {'name': 'ARM',      'type': 'integer', 'align': 'right', 'context': 'meta'},
