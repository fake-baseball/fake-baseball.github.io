...
REGISTRY = {
    ...
    'player_id':  {'name': 'ID',         'type': 'text',    'context': 'meta'},
    ...
    'is_retired':         {'name': 'Retired',          'type': 'text',    'context': 'meta'},
    'retirement_season':  {'name': 'Retirement Season','type': 'integer', 'context': 'meta'},
