...
REGISTRY = {
    ...
    'first_name': {'name': 'First Name', 'type': 'text',    'context': 'meta'},
    'last_name':  {'name': 'Last Name',  'type': 'text',    'context': 'meta'},
    'jersey':     {'name': '#', 'label': 'Jersey Number', 'type': 'integer', 'context': 'meta'},
    'salary':     {'name': 'Salary',     'type': 'salary',  'context': 'meta'},
    ...
    't_gb':          {'name': 'GB',       'label': 'Games Back',       'type': 'gb',        'context': 'meta'},
    't_rs':          {'name': 'RS',       'label': 'Runs Scored',      'type': 'integer',   'context': 'meta'},
    't_ra':          {'name': 'RA',       'label': 'Runs Against',     'type': 'integer',   'context': 'meta'},
    't_diff':        {'name': 'Diff',     'label': 'Run Differential', 'type': 'rdiff',     'context': 'meta'},
    # Split records (W-L strings)
    't_last10':      {'name': 'L10',    'label': 'Record Last 10 Games',                 'type': 'record', 'context': 'meta'},
    't_div':         {'name': 'Div',    'label': 'Record vs. Divisional Opponents',      'type': 'record', 'context': 'meta'},
    't_conf':        {'name': 'Conf',   'label': 'Record vs. Conference Opponents',      'type': 'record', 'context': 'meta'},
    't_inter':       {'name': 'Inter',  'label': 'Record vs. Interconference Opponents', 'type': 'record', 'context': 'meta'},
    't_one_run':     {'name': '1-Run',  'label': 'Record in 1-Run Games',                'type': 'record', 'context': 'meta'},
    't_blowout':     {'name': 'Blowout','label': 'Record in >5-Run Games',               'type': 'record', 'context': 'meta'},
    't_home':        {'name': 'Home',   'label': 'Record in Home Games',                 'type': 'record', 'context': 'meta'},
    't_away':        {'name': 'Away',   'label': 'Record in Away Games',                 'type': 'record', 'context': 'meta'},
    't_vs500':       {'name': '>.500',  'label': 'Record vs. Teams Above .500',          'type': 'record', 'context': 'meta'},
    't_first_half':  {'name': '1st',    'label': 'Record in First Half of Season',       'type': 'record', 'context': 'meta'},
    't_second_half': {'name': '2nd',    'label': 'Record in Second Half of Season',      'type': 'record', 'context': 'meta'},
    't_shutout':     {'name': 'SHO',    'label': 'Record in Shutouts',                   'type': 'record', 'context': 'meta'},
    't_sos':         {'name': 'SOS',    'label': 'Strength of Schedule (played)',    'type': 'stat', 'context': 'meta', 'decimal_places': 3, 'leading_zero': False, 'percentage': False},
    't_sos_rem':     {'name': 'SOSR',   'label': 'Strength of Schedule (remaining)', 'type': 'stat', 'context': 'meta', 'decimal_places': 3, 'leading_zero': False, 'percentage': False},
    # Game log columns
    ...
    'team':          {'name': 'Team',    'type': 'text',        'context': 'meta'},
    ...
    'pos1':          {'name': 'PP',      'label': 'Primary Position',   'type': 'text',    'context': 'meta'},
    'pos2':          {'name': '2P',      'label': 'Secondary Position', 'type': 'text',    'context': 'meta'},
    'role':          {'name': 'Role',    'label': 'Pitching Role',      'type': 'text',    'context': 'meta'},
    'throws':        {'name': 'T',       'label': 'Throws',             'type': 'text',    'context': 'meta'},
    'bats':          {'name': 'B',       'label': 'Bats',               'type': 'text',    'context': 'meta'},
    'power':         {'name': 'POW',     'label': 'Power',              'type': 'integer', 'context': 'meta'},
    'contact':       {'name': 'CON',     'label': 'Contact',            'type': 'integer', 'context': 'meta'},
    'speed':         {'name': 'SPD',     'label': 'Speed',              'type': 'integer', 'context': 'meta'},
    'fielding':      {'name': 'FLD',     'label': 'Fielding',           'type': 'integer', 'context': 'meta'},
    'arm':           {'name': 'ARM',     'label': 'Arm',                'type': 'integer', 'context': 'meta'},
    'velocity':      {'name': 'VEL',     'label': 'Velocity',           'type': 'integer', 'context': 'meta'},
    'junk':          {'name': 'JNK',     'label': 'Junk',               'type': 'integer', 'context': 'meta'},
    'accuracy':      {'name': 'ACC',     'label': 'Accuracy',           'type': 'integer', 'context': 'meta'},
    'arsenal':       {'name': 'Arsenal', 'label': 'Pitch Arsenal',      'type': 'text',    'context': 'meta'},
    'dh_off':        {'name': 'OFF',     'type': 'stat', 'decimal_places': 3, 'leading_zero': True,  'context': 'meta'},
    'dh_def':        {'name': 'DEF',     'type': 'stat', 'decimal_places': 3, 'leading_zero': True,  'context': 'meta'},
    'p_dh':          {'name': 'P(DH)',   'type': 'stat', 'decimal_places': 1, 'leading_zero': True, 'percentage': True, 'context': 'meta'},
    'rpos_per_gb':   {'name': 'Rpos/G',  'type': 'stat', 'decimal_places': 3, 'leading_zero': True,  'context': 'meta'},
    'rpos_per_80g':  {'name': 'Rpos/80G','type': 'stat', 'decimal_places': 2, 'leading_zero': False, 'context': 'meta'},
    'rdef_attr':     {'name': 'Rdef(A)',   'type': 'stat', 'decimal_places': 1, 'leading_zero': True,  'context': 'meta'},
    'rdef_e20':      {'name': 'Rdef(E20)', 'type': 'stat', 'decimal_places': 1, 'leading_zero': True,  'context': 'meta'},
    'rdef_old':      {'name': 'Rdef(S20)', 'type': 'stat', 'decimal_places': 1, 'leading_zero': True,  'context': 'meta'},
    'rdef':          {'name': 'Rdef',      'type': 'stat', 'decimal_places': 1, 'leading_zero': True,  'context': 'meta'},
}
